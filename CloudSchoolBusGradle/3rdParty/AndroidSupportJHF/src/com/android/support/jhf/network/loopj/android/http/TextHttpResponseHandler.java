...
public abstract class TextHttpResponseHandler extends AsyncHttpResponseHandler {
     ...
     * @param responseString string response of given charset
     */
    public abstract void onSuccess(int statusCode, Header[] headers, String responseString, HttpResponse response);

    @Override
    public void onSuccess(int statusCode, Header[] headers, byte[] responseBytes, HttpResponse response) {
        onSuccess(statusCode, headers, getResponseString(responseBytes, getCharset()), response);
    }
