...
//     * @param params          additional GET parameters to send with the request.
//     * @param responseHandler the response handler instance that should handle the response.
//     * @param iStateListener  state listener
//     * @return RequestHandle of future request process
//     */
//    public RequestHandle get(Context context, String url, Header[] headers, RequestParams params, ResponseHandlerInterface responseHandler, IStateListener iStateListener) {
//        HttpUriRequest request = new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url, params));
//        if (headers != null) request.setHeaders(headers);
//        responseHandler.setStateListener(iStateListener);
//        return sendRequest(httpClient, httpContext, request, null, responseHandler,
//                context);
//    }
