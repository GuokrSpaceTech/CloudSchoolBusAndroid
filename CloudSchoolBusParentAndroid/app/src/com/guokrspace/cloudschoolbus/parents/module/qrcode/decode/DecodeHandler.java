package com.guokrspace.cloudschoolbus.parents.module.qrcode.decode;
...
import com.guokrspace.cloudschoolbus.parents.module.qrcode.ZbarManager;
import com.guokrspace.cloudschoolbus.parents.module.qrcode.bitmap.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
	...
	private void decode(byte[] data, int width, int height) {
		...
		String result = manager.decodeRaw(rotatedData, width, height, true, activity.getX(), activity.getY(), activity.getCropWidth(),
