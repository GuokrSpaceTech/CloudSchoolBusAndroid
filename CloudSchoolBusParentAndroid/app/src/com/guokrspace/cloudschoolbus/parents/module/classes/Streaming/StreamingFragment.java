...
public class StreamingFragment extends BaseFragment {
    ...
    private ArrayList<MessageEntity> streamingEntities = new ArrayList<MessageEntity>();
...
//        ((MainActivity)mParentContext).getmOptionMenuItem().setVisible(false);
        ...
        mMaterialListView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!loading && (totalItemCount - visibleItemCount) <= (firstVisibleItem + visibleThreshold)) {
                    ...
                    Log.i("...", "end called");
                    MessageEntity attendanceEntity = streamingEntities.get(streamingEntities.size() - 1);
    ...
    private void GetEntitiesFromCache() {
        ...
        streamingEntities = (ArrayList<MessageEntity>) queryBuilder.where(MessageEntityDao.Properties.Apptype.eq("OpenClass")).list();

        if (streamingEntities.size() != 0)
