 ...
 */
public class FoodNoticeCardItemView extends CardItemView<FoodNoticeCard> {

    public FoodNoticeCardItemView(Context context) {
        super(context);
    }

    public FoodNoticeCardItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FoodNoticeCardItemView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    @Override
    public void build(FoodNoticeCard card) {
        super.build(card);
