...
public class ShowActivityRegisterActivity extends Activity {
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			case NETISNOTWORKING:
				Toast.makeText(ShowActivityRegisterActivity.this, R.string.have_no_network, Toast.LENGTH_SHORT).show();
				break;
			case APPLY_SUCCESS:
				Toast.makeText(ShowActivityRegisterActivity.this, R.string.apply_success, Toast.LENGTH_SHORT).show();
				register.setBackgroundResource(R.drawable.activity_apply_have);
				break;
			case APPLY_SUCCESS_:
				Toast.makeText(ShowActivityRegisterActivity.this, R.string.apply_success_, Toast.LENGTH_SHORT).show();
				register.setBackgroundResource(R.drawable.activity_apply);
				break;
			case MANGAGEFAIL:
				Toast.makeText(ShowActivityRegisterActivity.this, R.string.manage_fail, Toast.LENGTH_SHORT).show();
				break;
			case REGISTERFU5:
				Toast.makeText(ShowActivityRegisterActivity.this, R.string.registerimg_msg_fu5, Toast.LENGTH_SHORT).show();
				break;
			case REGISTERFU6:
				Toast.makeText(ShowActivityRegisterActivity.this, R.string.registerimg_msg_fu6, Toast.LENGTH_SHORT).show();
				break;
			case REGISTERFU7:
				Toast.makeText(ShowActivityRegisterActivity.this, R.string.registerimg_msg_fu7, Toast.LENGTH_SHORT).show();
				break;
			case REGISTERFU8:
				Toast.makeText(ShowActivityRegisterActivity.this, R.string.registerimg_msg_fu8, Toast.LENGTH_SHORT).show();
				break;
			}
			return false;
		}
	...
	private void showShare(boolean silent, String platform) {
		...
		oks.show(ShowActivityRegisterActivity.this);
	}
		...
		Thread thread = new Thread(new Runnable() {
			...
			public void run() {
				...
				if (HttpUtil.isNetworkConnected(ShowActivityRegisterActivity.this)) {
					...
					Result result = HttpUtil.httpPost(ShowActivityRegisterActivity.this, param);
					if (result == null) {
