...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
	...
	private ByteBuffer mPixel = ByteBuffer.allocate(1080*720*2) ;
	...
	private ByteBuffer m_pStreamData = ByteBuffer.allocate(128*1024);
	private ByteBuffer m_pRecvBuff   = ByteBuffer.allocate(Net_LAYER_STRUCT_LEN);
