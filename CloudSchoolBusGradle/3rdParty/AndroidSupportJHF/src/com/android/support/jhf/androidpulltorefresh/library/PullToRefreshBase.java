 ...
 *******************************************************************************/
package com.android.support.jhf.androidpulltorefresh.library;

import com.android.support.jhf.androidpulltorefresh.library.internal.FlipLoadingLayout;
import com.android.support.jhf.androidpulltorefresh.library.internal.LoadingLayout;
import com.android.support.jhf.androidpulltorefresh.library.internal.RotateLoadingLayout;
import com.android.support.jhf.androidpulltorefresh.library.internal.Utils;
import com.android.support.jhf.androidpulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
		...
		switch (event.getAction()) {
			...
			case MotionEvent.ACTION_UP: {
				if (mIsBeingDragged) {
					...
					// If we're already refreshing, just scroll back to the ic_back_to_top
					if (isRefreshing()) {
						smoothScrollTo(0);
						return true;
					}
	...
	/**
	 * @return Either {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.Orientation#VERTICAL} or
	 *         {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
	 */
	 ...
	 * 
	 * @return true if the View is currently the correct state (for example, ic_back_to_top
	 *         of a ListView)
	 */
	 ...
	 * {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.State#PULL_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.State#REFRESHING} or {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 * 
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.State#RESET} state.
	 */
	...
	public static enum Mode {
		 ...
		 * {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction - One of {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is
		 *            {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.State#PULL_TO_REFRESH} or
		 *            {@link com.android.support.jhf.androidpulltorefresh.library.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
		 */
