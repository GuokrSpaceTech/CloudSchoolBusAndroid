...
import com.guokrspace.cloudschoolbus.teacher.module.classes.Streaming.Messages.NET_LAYER;
                                                ...
                                                if (pPackage.byBlockEndFlag == 1) {
                                                    if (pPackage.byFrameType == 0 || pPackage.byFrameType == 1 || pPackage.byFrameType == 4)//BP帧或I帧
                                                    {
                                                        ...
                                                        if (h264Decoder != null) {
                                                            ...
                                                            h264Decoder.consumeNalUnitsFromDirectBuffer(m_pStreamData, m_iFrameLen, H264Decoder.COLOR_FORMAT_YUV420);
