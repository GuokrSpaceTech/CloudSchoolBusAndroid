...
import com.android.support.jhf.androidpulltorefresh.library.internal.EmptyViewMethodAccessor;
import com.android.support.jhf.androidpulltorefresh.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
	...
	public PullToRefreshAdapterViewBase(Context context) {
		...
		mRefreshableView.setOnItemLongClickListener(this);
	}
	 ...
	 * when the Adapter View is scrolled to the ic_back_to_top and the mode is set to
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		if(null != mOnItemClickListener){
			int tempArg2 = arg2-1;
			mOnItemClickListener.onItemClick(arg0, arg1, tempArg2, arg3);
		}
	}
	...
	public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int arg2,
		...
		if(null != mOnItemLongClickListener){
			int tempArg2 = arg2-1;
			return mOnItemLongClickListener.onItemLongClick(arg0, arg1, tempArg2, arg3); 
		}else {
			return false;
		}
	}
