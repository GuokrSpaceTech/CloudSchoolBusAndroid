 ...
 *******************************************************************************/
package com.android.support.jhf.universalimageloader.core;
...
import com.android.support.jhf.universalimageloader.cache.disc.DiscCacheAware;
import com.android.support.jhf.universalimageloader.cache.disc.impl.UnlimitedDiscCache;
import com.android.support.jhf.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.android.support.jhf.universalimageloader.cache.memory.MemoryCacheAware;
import com.android.support.jhf.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.android.support.jhf.universalimageloader.core.assist.ImageSize;
import com.android.support.jhf.universalimageloader.utils.MemoryCacheUtils;
import com.android.support.jhf.universalimageloader.core.assist.QueueProcessingType;
import com.android.support.jhf.universalimageloader.core.decode.ImageDecoder;
import com.android.support.jhf.universalimageloader.core.download.ImageDownloader;
import com.android.support.jhf.universalimageloader.core.download.NetworkDeniedImageDownloader;
import com.android.support.jhf.universalimageloader.core.download.SlowNetworkImageDownloader;
import com.android.support.jhf.universalimageloader.core.process.BitmapProcessor;
import com.android.support.jhf.universalimageloader.utils.L;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>threadPoolSize = {@link com.android.support.jhf.universalimageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_POOL_SIZE this}</li>
	 * <li>threadPriority = {@link com.android.support.jhf.universalimageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_PRIORITY this}</li>
	...
	/**
	 * Builder for {@link com.android.support.jhf.universalimageloader.core.ImageLoaderConfiguration}
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 */
	public static class Builder {
		...
		/**
		 * Sets custom {@linkplain java.util.concurrent.Executor executor} for tasks of displaying <b>cached on disc</b> images (these tasks
		 ...
		 * {@link com.android.support.jhf.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.android.support.jhf.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.android.support.jhf.universalimageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.android.support.jhf.universalimageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.android.support.jhf.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.android.support.jhf.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.android.support.jhf.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.android.support.jhf.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.android.support.jhf.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Consider {@link com.android.support.jhf.universalimageloader.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
		...
		/** Builds configured {@link com.android.support.jhf.universalimageloader.core.ImageLoaderConfiguration} object */
