...
public class StudentHeaderView extends RelativeLayout {
	...
	private Handler handler=new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			switch(msg.what){
			case OK:
				//Bitmap bitmap=ImageUtil.round((Bitmap)msg.obj,DensityUtil.dip2px(getContext(), 20),Color.WHITE);
				Bitmap bitmap=ImageUtil.round((Bitmap)msg.obj,16,Color.WHITE);
	 ...
	 * @param attrs
	 */
	public StudentHeaderView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	public void setStudentHeaderBG(Bitmap bitmap){
		bitmap=ImageUtil.toRoundCorner(bitmap,75);
