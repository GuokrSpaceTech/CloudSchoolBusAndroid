...
JNIEXPORT jint JNICALL Java_com_Manga_Activity_myChildren_Streaming_Decoder_Init(JNIEnv* env, jobject thiz) {
...
JNIEXPORT jint JNICALL Java_com_Manga_Activity_myChildren_Streaming_Decoder_free(JNIEnv* env,
		jobject thiz) {
	avcodec_close(c);
	av_free(c);
	av_free(picture);
...
JNIEXPORT jint JNICALL Java_com_Manga_Activity_myChildren_Streaming_Decoder_decodeFrame(
...
JNIEXPORT jint Java_com_Manga_Activity_myChildren_Streaming_Decoder_getWidth(JNIEnv* env, jobject thiz) {
  if(c)
  return c->width;
}

JNIEXPORT jint Java_com_Manga_Activity_myChildren_Streaming_Decoder_getHeight(JNIEnv* env, jobject thiz) {

  if(c)
  return c->height;
}

JNIEXPORT jint Java_com_Manga_Activity_myChildren_Streaming_Decoder_isInited(JNIEnv* env, jobject thiz) {
