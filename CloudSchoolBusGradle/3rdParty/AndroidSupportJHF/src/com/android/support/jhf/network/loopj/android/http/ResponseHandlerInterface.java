...
public interface ResponseHandlerInterface {
     ...
     */
    void sendStartMessage(AsyncHttpRequest asyncHttpRequest);

    /**
     * Notifies callback, that request was completed and is being removed from thread pool
     */
    void sendFinishMessage(AsyncHttpRequest asyncHttpRequest);
     ...
     */
    void sendSuccessMessage(int statusCode, Header[] headers, byte[] responseBody, HttpResponse response);
