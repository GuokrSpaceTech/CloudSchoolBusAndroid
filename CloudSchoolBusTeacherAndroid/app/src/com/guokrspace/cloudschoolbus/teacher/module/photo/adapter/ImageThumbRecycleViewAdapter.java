...
import com.guokrspace.cloudschoolbus.teacher.module.photo.view.SquareImageView;
...
public class ImageThumbRecycleViewAdapter extends RecyclerView.Adapter<ImageThumbRecycleViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String picturePath = mDataset.get(position).getPicturePath();
        picturePath = "file://" + picturePath;
        Picasso.with(mContext).load(picturePath).centerCrop().fit().into(holder.mThumbnail);
    }
