...
public class GrowFilesWorksActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ExpandableListAdapter adapter = new BaseExpandableListAdapter() {
			...
			private String[][] city = new String[][] {
					{ "郑州市", "开封市", "新乡市", "安阳市", "南阳市", "开封市", "新乡市", "安阳市", "南阳市", "开封市", "新乡市", "安阳市", "南阳市", "开封市",
							"新乡市", "安阳市", "南阳市" }, { "石家庄市", "邯郸市", "保定市", "廊坊市", "廊坊市" },
					{ "济南市", "青岛市", "日照市", "烟台市", "威海市" }, { "太原市", "大同市", "晋城市", "吕梁市", "长治市" } };
			...
			public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
				View item = View.inflate(GrowFilesWorksActivity.this, R.layout.grow_group_item, null);
			...
			public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
					ViewGroup parent) {
				View item = View.inflate(GrowFilesWorksActivity.this, R.layout.childrenitem, null);
		...
		expandableListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
				...
				Toast.makeText(GrowFilesWorksActivity.this, adapter.getChild(groupPosition, childPosition).toString(),
	...
	public void close(View view) {
		ActivityUtil.close(GrowFilesWorksActivity.this);
	}
