...
public class AuthCode {
		...
		try {
			...
			if (operation == DiscuzAuthcodeMode.Decode) {
				...
				if (CutString(result, 10, 16).equals(
					...
					temp = Base64Util.decode(CutString(source + "=",
							ckey_length));
					result = new String(RC4(temp, cryptkey));
	...
	// String deStr =
	// AuthCode.authcodeDecode("0084tuF6jOu8bVvO//fcV6fXL/CCcUYVJby2nQOofjRasbvrqYNupR6eQJ2rDnhh1XvxWTft4Ub5TSdZA2Y3Ts0yhH8UrziYy5dXl3MHC5freHTOdAfgfFofcnQvLwo+BvD1hT7J9qw57Ral4NC+KNTc/Vj1CzPpftA5P6qUO3KB",
	// key);
