 ...
 */
public class ScheduleDetailFragment extends BaseFragment implements AdvancedWebView.Listener {

    private AdvancedWebView mWebView;
    private String foodUrl = null;

    public static ScheduleDetailFragment newInstance(String foodUrl) {
