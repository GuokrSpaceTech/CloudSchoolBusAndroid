...
public class StudentEntityTDao extends AbstractDao<StudentEntityT, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Parentid = new Property(7, String.class, "parentid", false, "PARENTID");
    };

    private DaoSession daoSession;

    private Query<StudentEntityT> parentEntityT_StudentEntityTListQuery;
    private Query<StudentEntityT> classEntityT_StudentEntityTListQuery;
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'STUDENT_ENTITY_T' (" + //
                ...
                "'PARENTID' TEXT NOT NULL );"); // 7: parentid
    }
    ...
    protected void bindValues(SQLiteStatement stmt, StudentEntityT entity) {
        ...
        stmt.bindString(8, entity.getParentid());
    }

    @Override
    protected void attachEntity(StudentEntityT entity) {
    ...
    public StudentEntityT readEntity(Cursor cursor, int offset) {
        StudentEntityT entity = new StudentEntityT( //
            ...
            cursor.getString(offset + 7) // parentid
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, StudentEntityT entity, int offset) {
        ...
        entity.setParentid(cursor.getString(offset + 7));
     }
    ...
    /** Internal query to resolve the "studentEntityTList" to-many relationship of ParentEntityT. */
    public List<StudentEntityT> _queryParentEntityT_StudentEntityTList(String studentid) {
        synchronized (this) {
            if (parentEntityT_StudentEntityTListQuery == null) {
                QueryBuilder<StudentEntityT> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Studentid.eq(null));
                parentEntityT_StudentEntityTListQuery = queryBuilder.build();
            }
        }
        Query<StudentEntityT> query = parentEntityT_StudentEntityTListQuery.forCurrentThread();
        query.setParameter(0, studentid);
        return query.list();
    }

    /** Internal query to resolve the "studentEntityTList" to-many relationship of ClassEntityT. */
    public List<StudentEntityT> _queryClassEntityT_StudentEntityTList(String studentid) {
        synchronized (this) {
            if (classEntityT_StudentEntityTListQuery == null) {
                QueryBuilder<StudentEntityT> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Studentid.eq(null));
                classEntityT_StudentEntityTListQuery = queryBuilder.build();
            }
        }
        Query<StudentEntityT> query = classEntityT_StudentEntityTListQuery.forCurrentThread();
        query.setParameter(0, studentid);
        return query.list();
    }
