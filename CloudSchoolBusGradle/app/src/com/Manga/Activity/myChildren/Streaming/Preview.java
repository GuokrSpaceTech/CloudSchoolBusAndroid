...
public class Preview extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        client.m_sStreamIP = mIpcparam.getDdns();
        client.m_iStreamPort = Integer.parseInt(mIpcparam.getPort());
        int i = intent.getIntExtra("id",0);
        client.m_sDVRName = mIpcparam.getDvr().get(i).getDvr_name();
        client.m_iChnNo = Integer.parseInt(mIpcparam.getDvr().get(i).getChannelid());
