...
public class ManageChildrenActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ActivityUtil.managechildren = this;
		...
		Thread thread = new Thread(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				DB db = new DB(ManageChildrenActivity.this);
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message message) {
			...
			case SELECTCHILDRENSUCCESS:
				...
				listView.setAdapter(new ManageChildrenAdapter(ManageChildrenActivity.this, list));
				break;
			case SELECTCHILDRENFIAL:
				missDialog();
				Toast.makeText(ManageChildrenActivity.this, R.string.children_manage_fail, Toast.LENGTH_SHORT).show();
				break;
			case SELECTCHILDRENSUCCESS1:
				missDialog();
				Toast.makeText(ManageChildrenActivity.this, R.string.children_manage_success, Toast.LENGTH_SHORT)
						.show();
				break;
			...
			case NETISNOTWORKING:
				missDialog();
				Toast.makeText(ManageChildrenActivity.this, R.string.out_time, Toast.LENGTH_SHORT).show();
				break;
			}
			return false;
		}
	...
	public void close(View view) {
		ActivityUtil.close(ManageChildrenActivity.this);
	}
